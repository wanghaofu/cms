...
case "4" :
	$TPL->assign( "installType", $IN['installType'] );
	if ( mysql_connect( $db_config['db_host'], $db_config['db_user'], $db_config['db_password'] ) && mysql_select_db( $db_config['db_name'] ) )
	{
...
echo "<?=";
echo "\$version?></a> <BR> &nbsp; Copyright &copy; <a href=\"http://www.localhost.com\" target=\\\"_blank\\\" id='description'>CMSware</a> 1999-";
echo "<?=";
