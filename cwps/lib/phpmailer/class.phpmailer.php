...
class PHPMailer
{
    ...
    */
    ...
    function MailSend($header, $body)
    {
        ...
        if ($this->Sender != "" && ini_get("safe_mode") == 0 && strtolower(ini_get("safe_mode")) != "on") {
     ...
     * @param int    $length  Length of message
     * @param bool   $qp_mode Optional
     *
     * @return string
     */
     ...
     * @access private
     *
     * @param string $value Value of textline
     *
     * @return string
     */
    ...
    function RFCDate()
    {
        ...
        $tzs    = ($tz < 0) ? "-" : "+";
        $tz     = abs($tz);
        $tz     = intval($tz/3600)*100 + ($tz%3600)/60;
     ...
     *
     * @param array $custom_header Array with custom header
     *
     * @return void
     */
