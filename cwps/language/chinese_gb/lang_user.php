...
$_LANG_MESSAGES = array(
	...
	'product.add.ok'=> "新增产品成功",
	'product.add.fail'=> "新增产品失败",
	'product.edit.ok'=> "编辑产品成功",
	'product.edit.fail'=> "编辑产品失败",
	'product.edit.RegisterURLExists'=>"注册URL已经存在,请使用其他URL",
	'product.add.RegisterURLExists'=>"注册URL已经存在,请使用其他URL",
	'product.ProductID.null'=>"错误，ProductID 为空",
	'product.submit.ok'=>"订单提交成功",
	'product.submit.fail'=>"订单提交失败",
	'product.add.newProductMailNotice.ok'=>"新订单邮件通知发送成功",
	'product.add.newProductMailNotice.fail'=>"新订单邮件通知发送失败",
	'product.add.usernameNotExists'=>"添加产品失败，注册用户不存在",

	'product.edit.usernameNotExists'=>"编辑产品失败，注册用户不存在",
	'product.sendLicenseNotice.ok'=>"重发License更新通知成功 ProductID= %s ",
	'product.sendLicenseNotice.fail'=>"重发License更新通知失败 ProductID= %s ",
	'product.sendLicenseNotice.continue'=>"继续... ",


	'product.sendFinishNotice.ok'=>"重发软件包准备完成通知成功 ProductID= %s ",
	'product.sendFinishNotice.fail'=>"重发软件包准备完成通知失败 ProductID= %s ",
	'product.sendFinishNotice.continue'=>"继续... ",

	'product.sendSubmitNotice.ok'=>"重发订单成功接受通知成功 ProductID= %s ",
	'product.sendSubmitNotice.fail'=>"重发订单成功接受通知失败 ProductID= %s ",
	'product.sendSubmitNotice.continue'=>"继续... ",


	'sendmail.send.ok'=>"邮件发送成功",
	'sendmail.send.fail'=>"邮件发送失败",
