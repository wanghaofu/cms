<?php
//CWPS及OAS接口定义
$SYS_ENV['CWPS_URL'] = "http://localhost/cmsphp4/cwps/";		//CWPS的URL，请勿忘记最后的斜框"/"
$SYS_ENV['OAS_URL']	= "http://localhost/cmsphp4/oas/";		//OAS的URL，请勿忘记最后的斜框"/"
$SYS_ENV['CookiePre'] = "cmsware_passport_oas_";	//无须更改
$SYS_ENV['OASID']   =  "1";						//CWPS中的OAS管理中定义的用以处理本OAS的OASID
$SYS_ENV['TransactionAccessKey'] = "80d625a26bc59c7c19e9e305e300a8fc";		//CWPS设置的该OAS的CWPS访问密码
...
//应用程序接口全局定义
$SYS_ENV['passport_key']    =  "80d625a26bc59c7c19e9e305e300a8fc";	//OAS与应用程序间设置的通行证密码
$SYS_ENV['main_domain']	=	"";				//登陆状态COOKIE作用的域名范围，一般设为你的主域，不要忘记前面的"."
