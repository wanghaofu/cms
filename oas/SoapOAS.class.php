	...
	*/
	function SoapOAS($server_address)
	{
		...
		$this->ActionReqTpl = 
							...
							."<SOAP-ENV:Header>"
							."    <TransactionID xmlns=\"http://www.sesoe.com/passport/schemas/\">{TransactionID}</TransactionID>"
							."    <TransactionAccessKey xmlns=\"http://www.sesoe.com/passport/schemas/\">{TransactionAccessKey}</TransactionAccessKey>"
							."    <TransactionEncrypt xmlns=\"http://www.sesoe.com/passport/schemas/\">{TransactionEncrypt}</TransactionEncrypt>"
							."<TransactionOASID xmlns=\"http://www.sesoe.com/passport/schemas/\">{OASID}</TransactionOASID>"
							."</SOAP-ENV:Header>"
							."<SOAP-ENV:Body>"
							."<ActionReq xmlns=\"http://www.sesoe.com/passport/schemas/\">"
