...
function InputPicker(action, form, element)
{
	...
	switch(action) {
		case 'color':
			var arr = showMeDialog("ui.php?sId=<?=$IN['sId']?>&o=editor__color.htm","color","dialogWidth:267px;dialogHeight:234px;help:0;status:0");	break;
		case 'date':
...
.tab {
	PADDING-RIGHT: 5px; PADDING-LEFT: 5px; FONT-SIZE: 12px; PADDING-BOTTOM: 1px; CURSOR: pointer;_cursor:hand; PADDING-TOP: 5px; LETTER-SPACING: 1px
}
.tab label{
...
("<?php echo $_LANG_SKIN['Sunday']; ?>",
 "<?php echo $_LANG_SKIN['Monday']; ?>",
 "<?php echo $_LANG_SKIN['Tuesday']; ?>",
 "<?php echo $_LANG_SKIN['Wednesday']; ?>",
 "<?php echo $_LANG_SKIN['Thursday']; ?>",
 "<?php echo $_LANG_SKIN['Friday']; ?>",
 "<?php echo $_LANG_SKIN['Saturday']; ?>",
 "<?php echo $_LANG_SKIN['Sunday']; ?>");
Calendar._MN = new Array
("<?php echo $_LANG_SKIN['January']; ?>",
 "<?php echo $_LANG_SKIN['February']; ?>",
 "<?php echo $_LANG_SKIN['March']; ?>",
 "<?php echo $_LANG_SKIN['April']; ?>",
 "<?php echo $_LANG_SKIN['May']; ?>",
 "<?php echo $_LANG_SKIN['June']; ?>",
 "<?php echo $_LANG_SKIN['July']; ?>",
 "<?php echo $_LANG_SKIN['August']; ?>",
 "<?php echo $_LANG_SKIN['September']; ?>",
 "<?php echo $_LANG_SKIN['October']; ?>",
 "<?php echo $_LANG_SKIN['November']; ?>",
 "<?php echo $_LANG_SKIN['December']; ?>");

Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Toggle first day of week";
Calendar._TT["PREV_YEAR"] = "<?php echo $_LANG_SKIN['Last_year']; ?>  ";
Calendar._TT["PREV_MONTH"] = "<?php echo $_LANG_SKIN['Last_month']; ?>  ";
Calendar._TT["GO_TODAY"] = "<?php echo $_LANG_SKIN['Today']; ?>";
Calendar._TT["NEXT_MONTH"] = "<?php echo $_LANG_SKIN['Next_month']; ?>  ";
Calendar._TT["NEXT_YEAR"] = "<?php echo $_LANG_SKIN['Next_year']; ?>  ";
Calendar._TT["SEL_DATE"] = "<?php echo $_LANG_SKIN['select_date']; ?>";
Calendar._TT["DRAG_TO_MOVE"] = "Drag to move";
Calendar._TT["PART_TODAY"] = " <?php echo $_LANG_SKIN['Today1']; ?>";
Calendar._TT["MON_FIRST"] = "Display Monday first";
Calendar._TT["SUN_FIRST"] = "Display Sunday first";
Calendar._TT["CLOSE"] = "<?php echo $_LANG_SKIN_GLOBAL['close']; ?>";
Calendar._TT["TODAY"] = "<?php echo $_LANG_SKIN['Today']; ?>";
</script>
<script type="text/javascript">
...
<body bgcolor="#D6D3CE" STYLE="margin:0pt;padding:0pt;border: 1px buttonhighlight;" onload="top.document.title=document.title">
...
<table   border=0 width=100%   cellPadding=3 cellSpacing=0 >
 ...
 <tr class='tablelist'> 
              ...
              <td valign='middle'>
					...
					<td >&nbsp;&nbsp;标题颜色:</td>
              <td  ><input name='data_TitleColor' size=8 type='text' value="<?=htmlspecialchars($pInfo[TitleColor])?>"   >&nbsp;<input style="width:20px;padding-left:2px;text-align:center" name="button5" type='button' tabindex='13' value='...' onclick="InputPicker('color',this.form,'data_TitleColor')"> </td>
					</tr> 
					</table>
				</td>
				</tr>
<tr class='tablelist'> 
              <td align=right ><?php echo $_LANG_SKIN['publish_date']; ?></td>
              <td >
<input name="year" type="text" class="button" id="dTime" onFocus="return showCalendar('dTime', 'y-mm-dd');"      value="<?=$output_year?>"> 
                ...
                <?php echo $_LANG_SKIN['hour']; ?>
                <select name="minute">
                 <?=$output_minute?>
                  
                </select>
                <?php echo $_LANG_SKIN['minute']; ?> <select name="second">
                 <?=$output_second?>
                 
                </select>
                <?php echo $_LANG_SKIN['second']; ?>			  
			  </td>
</tr>
			<tr class='tablelist'> 
              <td align=right  width=60>副标题:</td>
              <td valign='middle'><input name='data_SubTitle' type='text' value="<?php echo htmlspecialchars($pInfo[SubTitle])?>" size=90%> </td> </tr> 
			  <tr class='tablelist'> 
              <td align=right  width=60>新闻图片:</td>
              <td valign='middle'><input name='data_Photo' type='text' value="<?php echo htmlspecialchars($pInfo[Photo]) ?>" size=100%  >&nbsp;<!--<input name="button5" type='button'  value='...' onclick="InputPicker('upload',this.form,'data_Photo')" style="margin-right: 0px;padding-right: 0px;"> 
-->

 
 <img  style="position: relative;left:0px;top: 4px;" src="../html/images/menu_open.gif" class="Dtoolbutton" onmouseover="this.className='Dtoolbutton';" onmouseout="this.className='Dtoolbutton';" onclick="this.className='Ctoolbutton';commonInputPicker(this,'img', 'document.FM', 'data_Photo')" title="" hspace="0" vspace="0">
...
function prepareSubmit()
{
 ...
 <Iframe name=EditContent      style="width:100%;height:380;border:5;" > 
                </Iframe> <textarea name="SaveContent" id="SaveContent"    style="height:350px;display:none;" class='button' id='Content' style='height:300;width=100%;overflow:auto;background-color:#FFFFFF;'>
...
<?php endif;?> 
 <tr class='tablelist'> 
		...
		<td class='line_height'>&nbsp;<input name='button5' type='button' tabindex='13' value='×' onclick="del(this.form.data_CustomLinks)" style="font:9pt;font-family: Verdana, Arial, Helvetica, sans-serif;"><br><br>&nbsp;<input name='button5' type='button' tabindex='13' value='∧' onclick=moveUp(this.form.data_CustomLinks)><br>&nbsp;<input name='button5' type='button' tabindex='13' value='∨' onclick=moveDown(this.form.data_CustomLinks)><br><br>&nbsp;<input name="button5" type='button' tabindex='13' value='...' onclick=editContentLink('CustomLinks')> 
              ...
              <td valign='middle'><textarea name='data_Intro' class='button' id='Intro' style='height:100px;width:100%;background-color:#FFFFFF;' ><?=htmlspecialchars($pInfo[Intro])?></textarea> </td> </tr> 
</table>
</DIV>
...
<tr class='tablelist'> 
			...
			<table>
			<tr>
			<td><?php echo $_LANG_SKIN['create_solid_link']; ?></td>
			<td><?php echo $_LANG_SKIN['create_index_link']; ?></td>
			</tr>
			<tr>
			<td>
...
<?php endif;?>
 <tr class='tablelist'> 
              <td align=right ><?php echo $_LANG_SKIN['top_height']; ?>:</td>
              <td >
...
<tr class='tablelist'> 
              <td align=right ><?php echo $_LANG_SKIN['pink_height']; ?>:</td>
              <td >
...
<tr>
<td align=right  ><?php echo $_LANG_SKIN['self_template']; ?>:</td>
...
<tr><td align=right  ><?php echo $_LANG_SKIN['self_psn_url']; ?> :</td>
              <td ><input name='SelfPSNURL' id="SelfPSNURL" type='text' value='<?=$pInfo['SelfPSNURL']?>' size=80%  >&nbsp; </td></tr>
			  
<tr><td align=right  > </td>
              <td > &nbsp; </td></tr>

<tr><td align=right  ><?php echo $_LANG_SKIN['self_url']; ?> :</td>
