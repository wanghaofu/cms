...
switch($IN[o]) {
	...
	case 'add_submit':
		...
		*/
		...
		if($user->add()) { 
			...
			//$user_extra->add();
			_goto("view", 'add_user_ok');

		} else {
			_goto("view", 'add_user_fail');
	...
	case 'edit_submit':
		...
		if($user->update($IN[uId])) { 
			...
			_goto("view", 'edit_user_ok');

		} else {
			_goto("view", 'edit_user_fail');
	...
	case 'del':
		...
		if($user->del($IN[uId])) {
			...
			_goto("view", 'del_user_ok');
			
		} else
			_goto("view", 'del_user_fail');
