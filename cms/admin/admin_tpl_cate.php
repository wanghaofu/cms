...
case "add_submit" :
	if ( empty( $IN[data_ParentTCID] ) )
	{
		...
		if ( !$sys->isAdmin( ) )
		{
			goback( "tpl_cate_permission_deny_notadmin" );
		}
	}
	else
	{
...
case "del" :
	...
	else if ( $tpl_cate->haveSon( $IN[TCID] ) && $IN[action] == "force" )
	{
...
case "move" :
	...
	else if ( $tpl_cate->update( $IN[TCID] ) )
	{
