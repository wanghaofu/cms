          ...
          <TD>
            <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR><!--
                ...
                UNSELECTABLE="on" title="<?php echo $_LANG_SKIN['main_content_help']; ?>"><label><?php echo $_LANG_SKIN['main_content']; ?></label></TD>
          ...
          <TD>
            <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR>
                ...
                background="../html/images/mpc/tab_active_bg.gif" 
                UNSELECTABLE="on"><label><?php echo $_LANG_SKIN['base_content']; ?></label></TD>
          ...
          <TD>
            <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR>
                ...
                UNSELECTABLE="on" TITLE="<?php echo $_LANG_SKIN['publish_setting_help']; ?>"><label><?php echo $_LANG_SKIN['publish_setting']; ?></label></TD>
		    ...
		    <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR>
                ...
                background="../html/images/mpc/tab_unactive_bg.gif" 
                UNSELECTABLE="on"><label><?php echo $_LANG_SKIN['publish_resources']; ?></label></TD>
...
<!--
<tr class='tablelist'> 
              <td align=right ><?php echo $_LANG_SKIN['sort_height']; ?>:</td>
              <td >
...
<fieldset class="search">
 	<legend><b><?php echo $_LANG_SKIN['photo']; ?></b></legend>
...
<fieldset class="search">
 	<legend><b><?php echo $_LANG_SKIN['attach']; ?></b></legend>
...
<fieldset class="search">
 	<legend><b><?php echo $_LANG_SKIN['Flash']; ?></b></legend>
<table border="0" cellpadding="3" cellspacing="0"   >
