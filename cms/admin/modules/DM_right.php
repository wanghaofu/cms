...
if ( extension_loaded( "gd" ) )
{
	...
	{
		$info['FreeType'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['FreeType'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['T1Lib Support'] )
	{
		$info['T1Lib'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['T1Lib'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['GIF Read Support'] )
	{
		$info['GIFRead'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['GIFRead'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['GIF Create Support'] )
	{
		$info['GIFCreate'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['GIFCreate'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['JPG Support'] )
	{
		$info['JPG'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['JPG'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['PNG Support'] )
	{
		$info['PNG'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['PNG'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['WBMP Support'] )
	{
		$info['WBMP'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['WBMP'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
	if ( $gd_info['XBM Support'] )
	{
		$info['XBM'] = "<FONT size=1 COLOR=#009900>{$_LANG_SKIN_GLOBAL[state_true]}</FONT>";
	}
	else
	{
		$info['XBM'] = "<FONT  COLOR=#FF0000>{$_LANG_SKIN_GLOBAL[state_false]}</FONT>";
	}
...
{
	$TPL->assign( "install_exists", 1 );
}
if ( file_exists( "../update.php" ) )
{
	$TPL->assign( "update_exists", 1 );
}
