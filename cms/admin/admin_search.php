...
case "search" :
	...
	{
		$date_where = "AND (i.PublishDate > {$Date} AND i.PublishDate < ".( $Date + 86400 ).")";
	}
	if ( $IN['Published'] == "0" )
	{
		$publish_where = " AND i.State=0 ";
	}
	else if ( $IN['Published'] == "1" )
	{
