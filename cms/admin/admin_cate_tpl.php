...
case "del" :
	...
	else if ( !empty( $IN[TID] ) && $cate_tpl->del( $IN[TID] ) )
	{
...
case "move" :
	...
	if ( !empty( $IN[multi] ) && !empty( $IN[pData] ) )
	{
		...
		if ( $result )
		{
			showmessage( "move_cate_tpl_ok", $referer );
		}
		else
		{
			showmessage( "move_cate_tpl_fail", $referer );
		}
	}
	else
	{
...
case "copy" :
	...
	if ( !empty( $IN[multi] ) && !empty( $IN[pData] ) )
	{
		...
		if ( $result )
		{
			showmessage( "copy_cate_tpl_ok", $referer );
		}
		else
		{
			showmessage( "copy_cate_tpl_fail", $referer );
		}
	}
	else
	{
