...
case "add_submit" :
	...
	if ( $pubAccess->add( ) )
	{
		_goto( "view", "add_publishaccess_ok" );
	}
	else
	{
		_goto( "view", "add_publishaccess_fail" );
	}
	break;
case "edit" :
	if ( empty( $IN[pId] ) )
...
case "edit_submit" :
	...
	{
		_goto( "view", "edit_publishaccess_ok" );
	}
	else
	{
		_goto( "view", "edit_publishaccess_fail" );
	}
	break;
case "del" :
	if ( empty( $IN[pId] ) )
	...
	{
		_goto( "view", "del_publishaccess_ok" );
	}
	else
	{
		_goto( "view", "del_publishaccess_fail" );
	}
	break;
}
