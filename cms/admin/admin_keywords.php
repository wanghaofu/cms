...
case "add_submit" :
	...
	if ( $keywords->add( ) )
	{
		...
		_goto( "view", "add_keywords_ok" );
	}
	else
	{
		_goto( "view", "add_keywords_fail" );
	}
	break;
case "edit" :
	if ( empty( $IN[kId] ) )
...
case "edit_submit" :
	...
	{
		cleardir( SYS_PATH."sysdata/cache/", "index.html;.htaccess" );
		_goto( "view", "edit_keywords_ok" );
	}
	else
	{
		_goto( "view", "edit_keywords_fail" );
	}
	break;
case "del" :
	if ( empty( $IN[kId] ) )
	...
	{
		cleardir( SYS_PATH."sysdata/cache/", "index.html;.htaccess" );
		_goto( "view", "del_keywords_ok" );
	}
	else
	{
		_goto( "view", "del_keywords_fail" );
	}
}
