...
case "add_submit" :
	...
	if ( $workflow->add( ) )
	{
		_goto( "view", "add_workflow_ok" );
	}
	else
	{
		_goto( "view", "add_workflow_fail" );
	}
	break;
case "edit" :
	if ( empty( $IN[wID] ) )
...
case "edit_submit" :
	...
	{
		_goto( "view", "edit_workflow_ok" );
	}
	else
	{
		_goto( "view", "edit_workflow_fail" );
	}
	break;
case "del" :
	if ( empty( $IN[wID] ) )
	...
	if ( $workflow->del( $IN[wID] ) )
	{
		...
		_goto( "view", "del_workflow_ok" );
	}
	else
	{
		_goto( "view", "del_workflow_fail" );
	}
	break;
case "add_state_submit" :
	...
	{
		_goto( "view", "add_workflow_state_ok" );
	}
	else
	{
		_goto( "view", "add_workflow_state_fail" );
	}
	break;
case "edit_state" :
	if ( empty( $IN[ID] ) )
...
case "edit_state_submit" :
	...
	{
		_goto( "view", "edit_workflow_state_ok" );
	}
	else
	{
		_goto( "view", "edit_workflow_state_fail" );
	}
	break;
case "del_state" :
	if ( empty( $IN[ID] ) )
	...
	if ( $workflow->del_state( $IN[ID] ) )
	{
		...
		_goto( "view", "del_workflow_state_ok" );
	}
	else
	{
		_goto( "view", "del_workflow_state_fail" );
	}
	break;
case "view_record" :
