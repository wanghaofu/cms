...
case "list" :
	...
	$_SESSION[ResourceListPage] = $pagenum < $_SESSION[ResourceListPage] ? $pagenum : $_SESSION[ResourceListPage];
	...
	if ( $Category == "img" )
	{
		$TPL->display( "resource_list.html" );
	}
	else if ( $Category == "attach" )
	{
		$TPL->display( "resource_attach_list.html" );
	}
	else if ( $Category == "flash" )
	{
		$TPL->display( "resource_flash_list.html" );
	}
	break;
case "admin_frameset" :
...
case "admin_list" :
	...
	if ( $Category == "img" )
	{
		$TPL->display( "resource_img_admin_list.html" );
	}
	else if ( $Category == "attach" )
	{
		$TPL->display( "resource_attach_admin_list.html" );
	}
	else if ( $Category == "flash" )
	{
		$TPL->display( "resource_flash_admin_list.html" );
	}
	break;
case "del" :
	if ( !empty( $IN[multi] ) && !empty( $IN[ResourceID] ) )
	{
		...
		if ( $result )
		{
			showmessage( "resource_multi_del_ok", $referer );
		}
		else
		{
			showmessage( "resource_multi_del_fail", $referer );
		}
	}
	else if ( $resource->delResource( $IN[ResourceID] ) )
	{
		showmessage( "resource_del_ok", $referer );
	}
	else
	{
		showmessage( "resource_del_fail", $referer );
	}
	break;
