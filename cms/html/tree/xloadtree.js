 ...
 */
//	"test1", "plugins.php?sId=95c949687fe8c596612e27615379800f&plugin=base&&o=index::tree_xml&NodeID=2", 
//"plugins.php?sId=95c949687fe8c596612e27615379800f&plugin=base&&o=admin_base::list&NodeID=2", "panelWork" , "2"

//tree.add(new WebFXLoadTreeItem(
//"妈咪宝贝", "plugins.php?sId=f2deabecd9852f19d5320f7fc6c9f7fa&plugin=base&&o=index::tree_xml&NodeID=123",
// "plugins.php?sId=f2deabecd9852f19d5320f7fc6c9f7fa&plugin=base&&o=admin_base::list&NodeID=123", "panelWork" , "123"));
...
function _startLoadXmlTree(sSrc, jsNode) {
	...
	xmlHttp.onreadystatechange = function () {
		if (xmlHttp.readyState == 4) {
			_xmlFileLoaded(xmlHttp.responseXML, jsNode); //加载文件
		}
	};
...
function _xmlTreeToJsTree(oNode) {
	...
	var extra = oNode.getAttribute("extra");
	// create jsNode
	var jsNode;
...
//function WebFXLoadTreeItem(sText, sXmlSrc, sAction, sTarget, sCId, eParent, sIcon, sOpenIcon) {
//function WebFXTreeItem(sText, sAction, sTarget, sCId, eParent, sIcon, sOpenIcon) {
//WebFXLoadTreeItem("[$var.Name]", "admin_tree.php?op=sId::[$sId];o::site_xml;NodeID::[$var.NodeID]", "admin_site.php?op=sId::[$sId];o::edit;NodeID::[$var.NodeID]", "panelWork", "[$var.NodeID]","","../html/tree/images/xp/folder_2.png", "../html/tree/images/xp/openfolder_2.png")
	jsNode.cId = cId;
	jsNode.extra = extra;
