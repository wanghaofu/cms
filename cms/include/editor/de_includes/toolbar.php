...
<?php if($this->__hideSave != true) { ?>
<td>
<img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_save.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='saveDevEdit();' title="<?php echo sTxtSave; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideFullScreen != true) { ?>
<td>
<img id=fullscreen border="0" src="<?php echo $DevEditPath; ?>/de_images/button_fullscreen.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='toggleSize();foo.focus();' title="<?php echo sTxtFullscreen; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<td>
...
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_find.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='ShowFindDialog();foo.focus();' title="<?php echo sTxtFindReplace; ?>" class=toolbutton unselectable="on"></td>
<td>
<img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21" unselectable="on"></td>
<td>
...
<td>
<img id="toolbarSpell" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_spellcheck.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='spellCheck();' title="<?php echo sTxtCheckSpelling; ?> (F7)" class=toolbutton unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>

<?php if($this->__hideRemoveTextFormatting != true) { ?>
<td>
<img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_remove_format.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("RemoveFormat");' title="<?php echo sTxtRemoveFormatting; ?>" class=toolbutton unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<?php if($this->__hideBold != true) { ?>
<td>
<img id="fontBold" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_bold.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Bold");foo.focus();' title="<?php echo sTxtBold; ?> (Ctrl+B)" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideUnderline != true) { ?>
<td>
<img id="fontUnderline" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_underline.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Underline");foo.focus();' title="<?php echo sTxtUnderline; ?> (Ctrl+U)" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideItalic != true) { ?>
<td>
<img id="fontItalic" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_italic.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Italic");foo.focus();' title="<?php echo sTxtItalic; ?> (Ctrl+I)" class=toolbutton unselectable="on"></td>
<?php } ?>

<?php if($this->__hideStrikethrough != true) { ?>
<td>
<img id="fontStrikethrough" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_strikethrough.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("Strikethrough");foo.focus();' title="<?php echo sTxtStrikethrough; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>

<?php if($this->__hideNumberList != true) { ?>
<td>
<img id="fontInsertOrderedList" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_numbers.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("InsertOrderedList");foo.focus();' title="<?php echo sTxtNumList; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideBulletList != true) { ?>
<td>
<img id="fontInsertUnorderedList" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_bullets.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("InsertUnorderedList");foo.focus();' title="<?php echo sTxtBulletList; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideDecreaseIndent != true) { ?>
<td>
<img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_decrease_indent.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Outdent");foo.focus();' title="<?php echo sTxtDecreaseIndent; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideIncreaseIndent != true) { ?>
<td>
<img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_increase_indent.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("Indent");foo.focus();' title="<?php echo sTxtIncreaseIndent; ?>" class=toolbutton unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<?php if($this->__hideSuperScript != true) { ?>
<td>
<img id="fontSuperScript" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_superscript.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("superscript");foo.focus();' title="<?php echo sTxtSuperscript; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideSubScript != true) { ?>
<td>
<img id="fontSubScript" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_subscript.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("subscript");foo.focus();' title="<?php echo sTxtSubscript; ?>" class=toolbutton unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<?php if($this->__hideLeftAlign != true) { ?>
<td>
<img id="fontJustifyLeft" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_align_left.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyLeft");foo.focus();' title="<?php echo sTxtAlignLeft; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideCenterAlign != true) { ?>
<td>
<img id="fontJustifyCenter" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_align_center.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyCenter");foo.focus();' title="<?php echo sTxtAlignCenter; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideRightAlign != true) { ?>
<td>
<img id="fontJustifyRight" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_align_right.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyRight");foo.focus();' title="<?php echo sTxtAlignRight; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideJustify != true) { ?>
<td>
<img id="fontJustifyFull" border="0" src="<?php echo $DevEditPath; ?>/de_images/button_align_justify.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out2(this);" onmousedown="button_down(this);" onClick='doCommand("JustifyFull");foo.focus();' title="<?php echo sTxtAlignJustify; ?>" class=toolbutton unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<?php if ($this->Libtype != '99999999' && $this->__hideHelp != true) { ?>
<td>
<img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_help.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doHelp()' title="<?php echo sTxtHelp; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
...
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<td><span id=fontColor><img id=toolbarFont border="0" src="<?php echo $DevEditPath; ?>/de_images/button_font_color<?php echo $xp; ?>.gif" width="21" height="20" onmouseover="button_over(this);  button_over(toolbarFontdrop)" onmouseout="button_out(this); button_out(toolbarFontdrop)" onmousedown="button_down(this);" onClick="(isAllowed()) ? doColorDirectly(1) : foo.focus()" class=toolbutton title="<?php echo sTxtColour; ?>" unselectable="on"></span><img id=toolbarFontdrop class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this); button_over(toolbarFont)" onClick="(isAllowed()) ? showMenu('colorMenu',157,158) : foo.focus()" onMouseOut="button_out(this); button_out(toolbarFont);" width="7" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_drop_menu.gif" border=0 unselectable="on"></td>
<?php } ?>
<?php if($this->__hideBackColor != true) { ?>
<td><span id=fontHighlight><img id=toolbarHighlight border="0" src="<?php echo $DevEditPath; ?>/de_images/button_highlight<?php echo $xp; ?>.gif" width="21" height="20" onmouseover="button_over(this);  button_over(toolbarHighlightdrop)" onmouseout="button_out(this); button_out(toolbarHighlightdrop)" onmousedown="button_down(this);" onClick="(isAllowed()) ? doColorDirectly(2) : foo.focus()" class=toolbutton title="<?php echo sTxtBackColour; ?>" unselectable="on"></span><img id=toolbarHighlightdrop class=toolbutton onMouseDown="button_down(this);" onMouseOver="button_over(this); button_over(toolbarHighlight)" onClick="(isAllowed()) ? showMenu('colorMenu2',157,158) : foo.focus()" onMouseOut="button_out(this); button_out(toolbarHighlight);" width="7" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_drop_menu.gif" border=0 unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<?php if($this->__hideTable != true) { ?>
<td id=toolbarTables>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_table_down.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="(isAllowed()) ? showMenu('tableMenu',160,262) : foo.focus()" class=toolbutton title="<?php echo sTxtTableFunctions; ?>" unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>
<?php if($this->__hideForm != true) { ?>
<td>
  <img class=toolbutton onMouseDown=button_down(this); onMouseOver=button_over(this); onClick="(isAllowed()) ? showMenu('formMenu',180,210) : foo.focus()" onMouseOut=button_out(this); type=image width="21" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_form_down.gif" border=0 title="<?php echo sTxtFormFunctions; ?>" unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>

<?php if($this->__hideFlash != true) { ?>
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_flash.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="(isAllowed()) ? showMenu('mediaMenu',100,180) : foo.focus()" class=toolbutton title="<?php echo sTxtFlash; ?>" unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<?php } ?>

<?php if($this->__hideImage != true) { ?>
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_image.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="(isAllowed()) ? showMenu('imageMenu',100,72) : foo.focus()" class=toolbutton title="<?php echo sTxtImage; ?>" unselectable="on"></td>
<td><img src="<?php echo $DevEditPath; ?>/de_images/seperator.gif" width="2" height="21"></td>
<!--td>
...
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_textbox.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="doTextbox()" class=toolbutton title="<?php echo sTxtTextbox; ?>" unselectable="on"></td>
<?php } ?>
 <?php if($this->__hideHorizontalRule != true) { ?>
<td>
<img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_hr.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick='doCommand("InsertHorizontalRule");foo.focus();' title="<?php echo sTxtInsertHR; ?>" class=toolbutton unselectable="on"></td>
<?php } ?>
<?php if($this->__hideSymbols != true) { ?>
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_chars.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="doChars()" class=toolbutton title="<?php echo sTxtChars; ?>" unselectable="on"></td>
<?php } ?>
<?php if($this->__hideProps != true) { ?>
<td>
  <img border="0" src="<?php echo $DevEditPath; ?>/de_images/button_properties.gif" width="21" height="20" onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" onClick="ModifyProperties()" class=toolbutton title="<?php echo sTxtPageProperties; ?>" unselectable="on"></td>
<?php } ?>

<?php if($this->__hideClean != true) { ?>
<td>
  <img class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" onClick="cleanCode()" onmouseout="button_out(this);" type=image width="21" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_clean_code.gif" border=0 title="<?php echo sTxtCleanCode; ?>" unselectable="on"></td>
<?php } ?>

<?php if($this->__hasCustomInserts == true) { ?>
<td>
<img class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" onClick="doCustomInserts()" onmouseout="button_out(this);" type=image width="21" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_custom_inserts.gif" border=0 title="<?php echo sTxtCustomInserts; ?>" unselectable="on"></td>
<?php } ?>

<?php if($this->__hideAbsolute != true) { ?>
<td>
<img id="fontAbsolutePosition_off" disabled class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" width="21" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_absolute_disabled.gif" border=0 title="<?php echo sTxtTogglePosition; ?>"><img id="fontAbsolutePosition" class=toolbutton onmousedown="button_down(this);" onmouseover="button_over(this);" onClick="doCommand('AbsolutePosition')" onmouseout="button_out2(this);" type=image width="21" height="20" src="<?php echo $DevEditPath; ?>/de_images/button_absolute.gif" border=0 title="<?php echo sTxtTogglePosition; ?>" style="display:none" unselectable="on"></td>
<?php } ?>
