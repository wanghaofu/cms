...
class mysqli
{
	...
	function connect( $params )
	{
		...
		if ( !( $this->connection = mysqli_connect( $params['db_host'], $params['db_user'], $params['db_password'] ) ) )
		{
			exit( "<b>kDB Error:</b> Connecting to MySQL failed,please contact to your administrator" );
		}
		if ( !empty( $params['db_name'] ) )
		{
			if ( mysqli_select_db( $params['db_name'] ) )
			{
	...
	function setCharset( $charset )
	{
		...
		$serverVersion = mysqli_get_server_info( $this->connection );
		...
		$result = mysqli_query( $this->connection ,"SHOW CHARACTER SET like '".$this->charset."'");
...
class DBRecordSet extends mysqli
{
