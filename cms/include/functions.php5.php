...
class LocalImgPathA2R {
	 ...
	 *
	 */
	public static function A2R(&$content) 
	{
	...
	public static function _parseContent(&$content)
	{
		global $SYS_ENV;
	...
	public static function _imgLocalFilter($img_data)
	{
		global $SYS_ENV;
	...
	public static function _output(&$value, $ImgArray, $localImgArray)
	{
		if(!empty($ImgArray)) {
	...
	public static function _localize($ImgArray)
	{
		global $SYS_ENV;
	...
	public static function recordExists($src)
	{
		global $db,$table,$IN;
 ...
 *@ignore
 */
function _goto($url, $message = NULL) {
	global $db;
	...
	echo "<script type='text/javascript'>window.location.href='{$GLOBALS['base_url']}o={$url}&message=$message'</script>";
	exit;
}
