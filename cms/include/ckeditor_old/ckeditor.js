...
(function() {
    ...
    e.extend(h.prototype, {
        ...
        function j(k) {
            var l = 0;
            for (var m = 0,
            n = i[k].length; m < n; m++) l += parseInt(this.getComputedStyle(i[k][m]) || 0, 10) || 0;
            return l;
        };
    ...
    a.scriptLoader = (function() {
        ...
        return {
            load: function(l, m, n, o) {
                ...
                var u = function(y, z) { (z ? r: s).push(y);
                    if (--q <= 0) {
        ...
        return {
            ...
            load: function(n, o, p) {
                ...
                if (k[q]) m(n, q, o, p);
                    ...
                    l[q] = r;
                    a.scriptLoader.load(a.getUrl(r + 'skin.js'),
                    function() {
                        m(n, q, o, p);
                    });
                }
    ...
    a.event.implementOn(k); (function() {
        var l = 0,
        m = function() {
            var x = 'editor' + ++l;
        ...
        v = function(x) {
            ...
            if (x.elementMode == 1 && y.is('textarea')) {
                ...
                if (z) {
                    ...
                    z.on('submit', A);
                    if (!z.$.submit.nodeName && !z.$.submit.length) z.$.submit = e.override(z.$.submit,
                    function(B) {
                        return function() {
                            x.updateElement();
    ...
    e.extend(a.editor.prototype, {
        ...
        setData: function(l, m, n) {
            ...
            this._.data = o.dataValue; ! n && this.fire('afterSetData', o);
        },
    ...
    a.htmlParser.fragment = function() {
        ...
        a.htmlParser.fragment.fromHtml = function(q, r, s) {
            ...
            function A(D) {
                ...
                if (v.length > 0) for (var F = 0; F < v.length; F++) {
                    ...
                    if ((!J || J[H]) && (!D || !I || I[D] || !f[D])) {
                        ...
                        v.splice(F, 1);
                        F--;
                    } else if (H == x.name) C(x, x.parent, 1),
                    F--;
                }
            };
            function B() {
                ...
                while (1) {
                    ...
                    if (!H.isUnknown && !x.isUnknown && !J[D]) {
                        if (x.isOptionalClose) t.onTagClose(I);
                            ...
                            var K = x.children,
                            L = K[K.length - 1];
                            if (! (L && L.name == 'li')) C(L = new a.htmlParser.element('li'), x); ! H.returnPoint && (H.returnPoint = x);
                            x = L;
                        } else if (D in f.$listItem && I != D) t.onTagOpen(D == 'li' ? 'ul': 'dl', {},
                        0, 1);
                        else if (I in l && I != D) { ! H.returnPoint && (H.returnPoint = x);
                            x = x.parent;
                        } else {
            ...
            t.onText = function(D) {
                ...
                B();
                A();
                if (r && (!x.type || x.name == 'body') && e.trim(D)) this.onTagOpen(r, {},
                0, 1);
                if (!z && !y) D = D.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, ' ');
    ...
    a.htmlParser.cssStyle = function() {
        var l, m = arguments[0],
        n = {};
        l = m instanceof a.htmlParser.element ? m.attributes.style: m; (l || '').replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
        function(o, p, q) {
            ...
            writeHtml: function(m, n) {
                ...
                if (n) {
                    for (;;) {
                        ...
                        if (!q) {
                            for (var v = 0,
                            w = this.children.length; v < w; v++) this.children[v].parent = p.parent;
    ...
    d.range = function(l) {
        ...
        d.range.prototype = {
            ...
            setStart: function(t, u) {
                var v = this;
                if (t.type == 1 && f.$empty[t.getName()]) u = t.getIndex(),
                t = t.getParent();
                v.startContainer = t;
                v.startOffset = u;
                if (!v.endContainer) {
            ...
            setEnd: function(t, u) {
                var v = this;
                if (t.type == 1 && f.$empty[t.getName()]) u = t.getIndex() + 1,
                t = t.getParent();
                v.endContainer = t;
                v.endOffset = u;
                if (!v.startContainer) {
            ...
            init: function(o) {
                ...
                o.addCommand(n, {
                    exec: function() {
                        ...
                        a.scriptLoader.load(a.getUrl(p.path + 'lang/' + q + '.js'),
                        function() {
    ...
    j.add('basicstyles', {
        ...
        init: function(m) {
            var n = function(q, r, s, t) {
                var u = new a.style(t);
                m.attachStyleStateChange(u,
                function(v) { ! m.readOnly && m.getCommand(s).setState(v);
                });
    ...
    i.coreStyles_superscript = {
        ...
        function o(q) {
            for (var r = 0,
            s = q.getChildCount(), t; r < s && (t = q.getChild(r)); r++) {
        ...
        k.button.prototype = {
            render: function(m, n) {
                ...
                if (this.modes) {
                    ...
                    m.on('beforeModeUnload',
                    function() {
                        if (m.mode && this._.state != 0) w[m.mode] = this._.state;
                    },
                    this);
                    m.on('mode', x, this); ! this.readOnly && m.on('readOnly', x, this);
                } else if (r) {
                    r = m.getCommand(r);
                    if (r) {
                        r.on('state',
    ...
    k.prototype.addButton = function(m, n) {
        ...
        var m = function(y, z) {
            ...
            B.on(z, D); (b.version > 7 ? A.$: A.$.selection.createRange()).execCommand(z);
        ...
        q = function(y) {
            ...
            case 1114112 + 86 : case 2228224 + 45 : var z = this.document.getBody();
                if (!c && z.fire('beforepaste')) y.cancel();
                else if (b.opera || b.gecko && b.version < 10900) z.fire('paste');
                return;
            case 1114112 + 88 : case 2228224 + 46 : var A = this;
        ...
        j.add('clipboard', {
            ...
            init: function(y) {
                ...
                function() {
                    ...
                    A.on(b.webkit ? 'paste': 'beforepaste',
                    function(B) {
                        if (u) return;
                        var C = {
                            mode: 'html'
    ...
    j.add('contextmenu', {
            ...
            init: function(o) {
                ...
                v = e.addFunction(function(x, y) {
                    ...
                    case B ? 39 : 37 : case 9:
                        ...
                        A.focus();
                        return false;
                    case B ? 37 : 39 : case 2228224 + 9 : A = a.document.getById(z + (x - 1));
        ...
        function q(r, s) {
            ...
            r = r.replace(/\b(nbsp|shy|gt|lt|amp)(?:,|$)/g,
            function(A, B) {
                var C = s ? '&' + B + ';': v[B],
                D = s ? v[B] : '&' + B + ';';
                t[C] = D;
    ...
    if (c) h.prototype.hasAttribute = e.override(h.prototype.hasAttribute,
    function(m) {
        return function(n) {
            var q = this;
        ...
        function Q(T) {
            return T.replace(/<!--\{cke_protected\}\{C\}([\s\S]+?)-->/g,
            function(U, V) {
                return decodeURIComponent(V);
            });
        };
        ...
        function S(T, U) {
            ...
            for (var aa = 0; aa < Z.length; aa++) T = T.replace(Z[aa],
            function(ab) {
                ab = ab.replace(Y,
                function(ac, ad, ae) {
                    return V[ae];
            ...
            function(ab) {
                return ab.replace(/<!--\{cke_protected\}([\s\S]+?)-->/g,
                function(ac, ad) {
        ...
        j.add('htmldataprocessor', {
            ...
            onLoad: function() { ! ('fillEmptyBlocks' in i) && (i.fillEmptyBlocks = 1);
            }
        });
    ...
    i.image_removeLinkByEmptyURL = true; (function() {
        ...
        function n(r, s) {
            ...
            t && (t = t.replace(/-moz-|-webkit-|start|auto/i, '')); ! t && s && (t = r.getComputedStyle('direction') == 'rtl' ? 'right': 'left');
            return t;
        };
        function o(r) {
    ...
    e.extend(i, {
        ...
        function y(G) {
            ...
            if (H) {
                for (var I = 0,
                J = G.getChildren(), K; K = J.getItem(I), I < J.count(); I++) {
            ...
            exec: function(G) {
                ...
                while ((M = R.getNextRange()) && ++S) {
                    ...
                    while (X = W.getNextParagraph()) {
                        ...
                        ad = Y.blockLimit,
                        ae;
                        for (var af = aa - 1; af >= 0 && (ae = Z[af]); af--) {
                ...
                s.addCommand('maximize', {
                    ...
                    exec: function() {
                        ...
                        if (this.state == 2) {
                            ...
                            u.getDocumentElement().setStyles(H); ! b.gecko && u.getDocumentElement().setStyle('position', 'fixed'); ! (b.gecko && b.quirks) && u.getBody().setStyles(H);
    ...
    j.add('newpage', {
        init: function(m) {
            m.addCommand('newpage', {
                ...
                exec: function(n) {
                    var o = this;
                    n.setData(n.config.newpage_html || '',
                    function() {
                        setTimeout(function() {
    ...
    j.add('resize', {
        init: function(m) {
            var n = m.config,
            o = m.element.getDirection(1); ! n.resize_dir && (n.resize_dir = 'both');
        ...
        j.add('scayt', {
            ...
            init: function(t) {
                ...
                if (t.contextMenu && t.addMenuItems) t.contextMenu.addListener(function(E, F) {
                    ...
                    typeof P != 'number' && (P = 5); ! P && (P = L.length);
                ...
                if (b.opera || b.air) t.on('instanceReady',
                function() {
                    D();
                });
                if (t.config.scayt_autoStartup) t.on('instanceReady',
                function() {
                    q.loadEngine(t);
                });
            },
        ...
        function p(G, H) {
            ...
            for (var Y = 0; U[Y] && Y < W; Y++) {
                ...
                if (U[Y].rowSpan > 1 && V && U[Y] == V[Y]) {
                    ...
                    Z = new h(U[Y]).clone();
                    Z.removeAttribute('rowSpan'); ! c && Z.appendBogus();
                    X.append(Z);
                    Z = Z.$;
                }
                Y += Z.colSpan - 1;
        ...
        function t(G, H) {
            ...
            for (S = 0; S < R; S++) {
                ...
                if (P[S].colSpan > 1 && Q.length && Q[S] == P[S]) {
                    ...
                    U = new h(P[S]).clone();
                    U.removeAttribute('colSpan'); ! c && U.appendBogus();
                    ...
                    if (r.focusManager.hasFocus) {
                        ...
                        if (u = t.getAscendant('td', true) || t.getAscendant('th', true)) {
                            ...
                            if (! (w || q)) {
                                ...
                                for (var A = 0,
                                B = y.length; A < B; A++) {
                                    var C = z.append(new h(y[A], r.document).clone(false, false)); ! c && C.appendBogus();
                                }
    ...
    h.prototype.focusPrevious = function(m, n) {
        ...
        t = 0,
        u,
        v = w.getDocument().getBody().getLast();
    ...
    i.templates_replaceContent = true; (function() {
        ...
        m.prototype.focus = function() {
            for (var o = 0,
            p; p = this.toolbars[o++];) for (var q = 0,
            r; r = p.items[q++];) {
                if (r.focus) {
                    r.focus();
                    return;
        ...
        j.add('toolbar', {
            init: function(o) {
                var p, q = function(r, s) {
                    ...
                    switch (s) {
                    case 9:
                    case 2228224 + 9 : while (!u || !u.items.length) {
    ...
    i.toolbarCanCollapse = true; (function() {
        ...
        function r(C) {
            ...
            G = G.replace(/\n/g, '<br>');
            if (! (F || c)) G = G.replace(new RegExp('<br>(?=</' + H + '>)'),
            function(M) {
                return e.repeat(M, 2);
            });
            if (b.gecko || b.webkit) {
            ...
            init: function(C) {
                ...
                function() {
                    ...
                    function U(V) {
                        ...
                        if (c && C.config.enterMode != 1) W.on('selectionchange',
                        function() {
                            var af = W.getBody(),
                        ...
                        setTimeout(function() {
                            ...
                            if (C.config.disableObjectResizing) try {
                                ...
                                C.document.getBody().on(c ? 'resizestart': 'resize',
                                function(ah) {
                    ...
                    C.addMode('wysiwyg', {
                        ...
                        getData: function() {
                            ...
                            if (V.ignoreEmptyParagraph) aa = aa.replace(m,
                            function(ab, ac) {
                                return ac;
                            });
                            if (Y) aa = Y + '\n' + aa;
                    ...
                    function(V) {
                        ...
                        if (W && !W.isLocked) {
                            ...
                            B.call(this, V);
                            C.fire('updateSnapshot'); ! X && C.resetDirty();
                        }
                    },
                    null, null, 1);
                });
                ...
                function J(L) {
                    ...
                    function() {
                        ...
                        M.setAttribute('contentEditable', true); ! L && J(1);
                    });
                };
    ...
    a.DIALOG_RESIZE_BOTH = 3; (function() {
        ...
        a.dialog.prototype = {
            ...
            addPage: function(S) {
                ...
                ae._.tabs[S.id] = [aa, X];
                ae._.tabIdList.push(S.id); ! S.hidden && ae._.pageCount++;
                ae._.lastTab = aa;
                ae.updateStyle();
        ...
        R = function(S) {
            ...
            k.dialog = {
                uiElement: function(S, T, U, V, W, X, Y) {
                    ...
                    aa.push('>', ad, '</', Z, '>');
                    U.push(aa.join('')); (this._ || (this._ = {})).dialog = S;
                    if (typeof T.isChanged == 'boolean') this.isChanged = function() {
                        return T.isChanged;
                    };
                    if (typeof T.isChanged == 'function') this.isChanged = T.isChanged;
                    if (typeof T.setValue == 'function') this.setValue = e.override(this.setValue,
                    function(an) {
                        return function(ao) {
                            an.call(this, T.setValue.call(this, ao));
                        };
                    });
                    if (typeof T.getValue == 'function') this.getValue = e.override(this.getValue,
                    function(an) {
                        return function() {
        ...
        k.dialog.uiElement.prototype = {
            ...
            setValue: function(S, T) {
                this.getInputElement().setValue(S); ! T && this.fire('change', {
                    value: S
                });
                return this;
            },
    ...
    a.STYLE_OBJECT = 3; (function() {
        ...
        function u(T) {
            ...
            if (T.collapsed) {
                ...
                X;
                for (var Y = 0,
                Z; Y < W.elements.length && (Z = W.elements[Y]); Y++) {
        ...
        function B(T) {
            ...
            V = T.getName(),
            W = C(T.getOuterHtml(), U,
            function(Y, Z, aa) {
                return Z + '</pre>' + aa + '<pre>';
            }),
            X = [];
            W.replace(/<pre\b.*?>([\s\S]*?)<\/pre>/gi,
            function(Y, Z) {
                X.push(Z);
            });
            return X;
        ...
        function C(T, U, V) {
            var W = '',
            X = '';
            T = T.replace(/(^<span[^>]+data-cke-bookmark.*?\/span>)|(<span[^>]+data-cke-bookmark.*?\/span>$)/gi,
            function(Y, Z, aa) {
                Z && (W = Z);
                aa && (X = aa);
                return '';
        ...
        function L(T, U) {
            for (var V in T) T[V] = T[V].replace(p,
            function(W, X) {
                return U[X];
            });
        };
    ...
    j.add('menu', {
        ...
        a.menu = e.createClass({
            $: function(n, o) {
                ...
                q = p.block.attributes = p.attributes || {}; ! q.role && (q.role = 'menu');
            ...
            _: {
                ...
                showSubMenu: function(n) {
                    ...
                    if (o) o.removeAll();
                        ...
                        o = v._.subMenu = new a.menu(v.editor, e.extend({},
                        v._.definition, {
                            level: v._.level + 1
                        },
                        true));
    ...
    i.editingBlock = true; (function() {
            ...
            init: function(y) {
                ...
                function() {
                    ...
                    if (c) {
                        ...
                        E.on('beforedeactivate',
                        function(M) {
                            if (M.data.$.toElement) return;
                            H = 0;
                            I = 1;
                        });
                        if (c && b.version < 8) y.on('blur',
                        function(M) {
                            try {
                        ...
                        if (c && (b.ie7Compat || b.version < 8 || b.quirks)) F.on('click',
                        function(M) {
        ...
        a.editor.prototype.createFakeParserElement = function(r, s, t, u) {
            ...
            w = v[t] || v.unknown,
            x,
            y = new a.htmlParser.basicWriter();
            r.writeHtml(y);
            x = y.getHtml();
            var z = {
                'class': s,
    ...
    k.richCombo = e.createClass({
        ...
        proto: {
            ...
            render: function(m, n) {
                ...
                m.on('mode', s, this); ! this.readOnly && m.on('readOnly', s, this);
    ...
    a.htmlWriter = e.createClass({
        ...
        $: function() {
            ...
            o._.rules = {};
            var m = f;
            for (var n in e.extend({},
            m.$nonBodyContent, m.$block, m.$listItem, m.$tableContent)) o.setRules(n, {
                indent: 1,
                breakBeforeOpen: 1,
                breakAfterOpen: 1,
        ...
        proto: {
            ...
            text: function(m) {
                var n = this;
                if (n._.indent) {
                    n.indentation(); ! n._.inPre && (m = e.ltrim(m));
                }
                n._.output.push(m);
            },
            comment: function(m) {
    ...
    a.UI_MENUBUTTON = 'menubutton'; (function() {
        var m = function(n) {
            var o = this._;
            if (o.state === 0) return;
    ...
    j.add('dialogui'); (function() {
        ...
        e.extend(k.dialog, {
            ...
            textInput: function(u, v, w) {
                ...
                u.on('load',
                function() {
                    A.getInputElement().on('keydown',
                    function(D) {
                        if (D.data.getKeystroke() == 13) B = true;
                    });
                    A.getInputElement().on('keyup',
                    function(D) {
            ...
            button: function(u, v, w) {
                ...
                u.on('load',
                function(A) {
                    var B = this.getElement(); (function() {
                        B.on('click',
                        function(C) {
                            x.fire('click', {
                                dialog: x.getDialog()
            ...
            select: function(u, v, w) {
                ...
                var y = function() {
                    ...
                    t(z);
                    for (var D = 0,
                    E; D < v.items.length && (E = v.items[D]); D++) B.push('<option value="', e.htmlEncode(E[1] !== undefined ? E[1] : E[0]).replace(/"/g, '&quot;'), '" /> ', e.htmlEncode(E[0]));
                    if (typeof z.inputStyle != 'undefined') z.style = z.inputStyle;
        ...
        k.dialog.checkbox.prototype = e.extend(new k.dialog.uiElement(), {
            ...
            setValue: function(u, v) {
                this.getInputElement().$.checked = u; ! v && this.fire('change', {
                    value: u
                });
            },
            getValue: function() {
        ...
        k.dialog.radio.prototype = e.extend(new k.dialog.uiElement(), {
            setValue: function(u, v) {
                ...
                x;
                for (var y = 0; y < w.length && (x = w[y]); y++) x.getElement().$.checked = x.getValue() == u; ! v && this.fire('change', {
                    value: u
                });
            },
            getValue: function() {
        ...
        onLoad: function() {
            ...
            k.listBlock = e.createClass({
                ...
                $: function(m, n) {
                    var q = this;
                    n = n || {};
                    var o = n.attributes || (n.attributes = {}); (q.multiSelect = !!n.multiSelect) && (o['aria-multiselectable'] = true); ! o.role && (o.role = 'listbox');
    ...
    a.themes.add('default', (function() {
        ...
        function n(o, p) {
            ...
            if (r) {
                ...
                q = t.getChild([0, 0, 0, 0]); ! o.sharedSpaces && (o.sharedSpaces = {});
                o.sharedSpaces[p] = q;
                o.on('focus',
                function() {
                    for (var u = 0,
                    v, w = r.getChildren(); v = w.getItem(u); u++) {
