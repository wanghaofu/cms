...
class AutoMini 
{
	...
	{	 
		if(isset($IN['copyright'])) {
			...
			die("<H1>AutoMini ".CLASS_VERSION."</H1> <HR>Copyright &copy; 1999-".date("Y")." <A HREF='http://www.localhost.com'>CMSware</A>&trade;. All rights reserved.<BR> ");
		}
	...
	function output()
	{
		...
		$urlinfo = parse_url($this->src);
		if(!in_array($urlinfo['host'], $this->allow_hosts)) {
...
$automini->allow_hosts = &$ALLOW_HOSTS;
$automini->output();
